(function (e, t) {
  ...
  return function () {
    ...
    function l(e, t) {
      ...
      if (i == null) i = z().createDocumentFragment();
      return i;
    }
    function g(e) {
    ...
    function N(e, t) {
      if (t.indexOf("closest ") === 0) return [H(e, t.substr(8))];
      else if (t.indexOf("find ") === 0) return [C(e, t.substr(5))];
      else if (t === "document") return [document];
      else if (t === "window") return [window];
      else return z().querySelectorAll(t);
    }
    function ee(e, t) {
      if (t) return N(e, t)[0];
      else return N(z().body, e)[0];
    }
    function k(e) {
      if (p(e, "String")) return C(e);
      else return e;
    }
    function I(e, t, r) {
      if (m(t)) return { target: z().body, event: e, listener: t };
      else return { target: k(e), event: t, listener: r };
    }
    function M(t, r, n) {
      lr(function () {
        var e = I(t, r, n);
    ...
    function ne(e) {
      var t = G(e, "hx-target");
      if (t) {
        if (t === "this") return re(e, "hx-target");
        else return ee(e, t);
      } else {
        var r = _(e);
        if (r.boosted) return z().body;
        else return e;
      }
    }
    function P(e) {
    ...
    function X(t, r) {
      W(t.attributes, function (e) {
        if (!r.hasAttribute(e.name) && P(e.name)) t.removeAttribute(e.name);
      });
      W(r.attributes, function (e) {
        if (P(e.name)) t.setAttribute(e.name, e.value);
      });
    }
    function j(e, t) {
      var r = sr(t);
    ...
    function fe(t) {
      var e = _(t);
      if (e.webSocket) e.webSocket.close();
      if (e.sseEventSource) e.sseEventSource.close();
      $(t, "htmx:beforeCleanupElement");
      if (e.listenerInfos) {
        W(e.listenerInfos, function (e) {
          if (t !== e.on) e.on.removeEventListener(e.trigger, e.listener);
        });
      }
      if (t.children) {
    ...
    function ce(e, t, r) {
      if (e.tagName === "BODY") return me(e, t, r);
      else {
        var n;
    ...
    function ye(e, t, r, n, i) {
      switch (e) {
        ...
        default:
          ...
          if (e === "innerHTML") me(r, n, i);
          else ye(U.config.defaultSwapStyle, t, r, n, i);
      }
    }
    function be(e) {
    ...
    function Te(e, t, r) {
      return Re.exec(e.charAt(0)) && e !== "true" && e !== "false" &&
        e !== "this" && e !== r && t !== ".";
    }
    function He(e, t, r) {
      if (t[0] === "[") {
            ...
            if (i === "every") {
              ...
              while (n.length > 0 && n[0] !== ",") {
                ...
                if (l === "changed") s.changed = true;
                  ...
                  (l === "root" || l === "threshold") && n[0] === ":"
                ) {
                  n.shift();
                  s[l] = c(n, Ce);
                } else J(e, "htmx:syntax:error", { token: n.shift() });
              }
              r.push(s);
            }
          }
          if (n.length === f) J(e, "htmx:syntax:error", { token: n.shift() });
          c(n, qe);
        } while (n[0] === "," && n.shift());
      }
      if (r.length > 0) return r;
      else if (d(e, "form")) return [{ trigger: "submit" }];
      else if (d(e, Ne)) return [{ trigger: "change" }];
    ...
    function De(e) {
      return location.hostname === e.hostname && f(e, "href") &&
        f(e, "href").indexOf("#") !== 0;
    }
    function Fe(t, r, e) {
      if (
        t.tagName === "A" && De(t) && t.target === "" || t.tagName === "FORM"
      ) {
        r.boosted = true;
        var n, i;
        if (t.tagName === "A") {
    ...
    function Xe(e, t) {
      return _(e).boosted && e.tagName === "A" && t.type === "click" &&
        (t.ctrlKey || t.metaKey);
    }
    function je(e, t) {
      var r = e.eventFilter;
      ...
      W(t, function (n) {
        var i = function (e) {
          ...
          if (t.handledFor.indexOf(o) < 0) {
            t.handledFor.push(o);
            if (l.consume) e.stopPropagation();
            if (l.target && e.target) if (!d(e.target, l.target)) return;
            if (l.once) {
    ...
    function _e(e) {
      if (!s(e, "data-hx-revealed") && b(e)) {
        ...
        var t = _(e);
        if (t.initialized) Z(t.verb, t.path, e);
        else {
    ...
    function Ze(u) {
      ...
      if (f) {
        u.addEventListener(ke(u)[0].trigger, function (e) {
          ...
          if (Pe(e, u)) e.preventDefault();
        });
      } else J(u, "htmx:noWebSocketSourceError");
    }
    function Ge(e) {
    ...
    function Ke(e, t, r) {
      ...
      for (var i = 0; i < n.length; i++) {
        var o = n[i].split(/:(.+)/);
        if (o[0] === "connect") Ye(e, o[1]);
        if (o[0] === "swap") Qe(e, o[1]);
      }
    }
    function Ye(t, e) {
    ...
    function Qe(o, a) {
      ...
      } else J(o, "htmx:noSSESourceError");
    }
    function et(e, t, r, n) {
      var i = h(e, rt);
      if (i) {
        ...
        var a = function () {
          if (!tt(i)) {
            if (Y(e)) Z(t, r, e);
            else o.removeEventListener(n, a);
          }
        };
        _(e).sseListener = a;
        o.addEventListener(n, a);
      } else J(e, "htmx:noSSESourceError");
    }
    function tt(e) {
      if (!Y(e)) {
    ...
    function it(o, a, e) {
      ...
      W(n, function (n) {
        if (s(o, "hx-" + n)) {
          ...
          a.verb = n;
          e.forEach(function (e) {
            if (e.sseEvent) et(o, n, i, e.sseEvent);
            else if (e.trigger === "revealed") {
              ze();
              _e(o);
            } else if (e.trigger === "intersect") {
              var t = {};
              if (e.root) t.root = ee(o, e.root);
              if (e.threshold) t.threshold = parseFloat(e.threshold);
              ...
              r.observe(o);
              Be(o, n, i, a, e);
            } else if (e.trigger === "load") nt(o, n, i, a, e.delay);
    ...
    function ot(e) {
      if (
        ...
        t.async = false;
        if (U.config.inlineScriptNonce) t.nonce = U.config.inlineScriptNonce;
    ...
    function ft(e) {
      if (e.closest && e.closest(U.config.disableSelector)) return;
      var t = _(e);
      if (!t.initialized) {
        t.initialized = true;
        ...
        var r = ke(e);
        var n = it(e, t, r);
        if (!n && G(e, "hx-boost") === "true") Fe(e, t, r);
        if (e.tagName === "FORM") ut(e);
        var i = V(e, "hx-sse");
        if (i) Ke(e, t, i);
        var o = V(e, "hx-ws");
        if (o) We(e, t, o);
    ...
    function $(e, t, r) {
      ...
      r["elt"] = e;
      var n = dt(t, r);
      if (U.logger && !vt(t)) U.logger(e, t, r);
      if (r.error) {
        pt(r.error);
    ...
    function yt(e, t, r, n) {
      ...
      while (i.length > U.config.historyCacheSize) i.shift();
      while (i.length > 0) {
        try {
    ...
    function Rt(n) {
      ...
      e.onload = function () {
        ...
        } else J(z().body, "htmx:historyCacheMissLoadError", i);
      };
      e.send();
    }
    function Ot(e) {
      ...
      if (t) {
        ...
        if (U.config.refreshOnHistoryMiss) window.location.reload(true);
        else Rt(e);
      }
    }
    function Lt(e) {
    ...
    function kt(t, r, n, e, i) {
      ...
      if (Nt(e)) {
        ...
        if (e.files) a = y(e.files);
        if (o != null && a != null) {
          var s = r[o];
          if (s) {
            if (Array.isArray(s)) {
              if (Array.isArray(a)) r[o] = s.concat(a);
              else s.push(a);
            } else {
              if (Array.isArray(a)) r[o] = [s].concat(a);
              else r[o] = [s, a];
    ...
    function Mt(e, t) {
      ...
      if (t !== "get") kt(r, i, o, H(e, "form"), s);
      kt(r, n, o, e, s);
      if (a.lastButtonClicked) {
        var l = f(a.lastButtonClicked, "name");
        if (l) n[l] = a.lastButtonClicked.value;
      }
    ...
    function Xt(e, t, r) {
      ...
      if (_(e).boosted) n["HX-Boosted"] = "true";
      return n;
    }
    function jt(t, e) {
      var r = G(e, "hx-params");
    ...
    function Ut(e, t) {
      ...
      if (_(e).boosted && !Bt(e)) n["show"] = "top";
      if (r) {
        var i = w(r);
        if (i.length > 0) {
          n["swapStyle"] = i[0];
          for (var o = 1; o < i.length; o++) {
            var a = i[o];
            if (a.indexOf("swap:") === 0) n["swapDelay"] = v(a.substr(5));
            if (a.indexOf("settle:") === 0) n["settleDelay"] = v(a.substr(7));
    ...
    function _t(e, t) {
      ...
      if (t.scroll) {
        var i = null;
        if (t.scrollTarget) i = ee(r, t.scrollTarget);
        if (t.scroll === "top" && (r || i)) {
          i = i || r;
          i.scrollTop = 0;
        }
    ...
    function Jt(e, t, r) {
      if (U.config.allowEval) return t();
      else {
    ...
    function er(e, t, r) {
      ...
      } else return Z(e, t, null, null, { returnPromise: true });
    }
    function tr(e) {
      var t = [];
      while (e) {
    ...
    function Z(e, t, n, f, r) {
      ...
      if (o) {
        var y = o.split(":");
        var b = y[0].trim();
        if (b === "this") p = re(n, "hx-sync");
        else p = ee(n, b);
        o = (y[1] || "drop").trim();
        i = _(p);
        if (o === "drop" && i.xhr && i.abortable !== true) return;
        else if (o === "abort") {
          if (i.xhr) return;
          else x = true;
        } else if (o === "replace") $(p, "htmx:abort");
      ...
      if (i.xhr) {
        if (i.abortable) $(p, "htmx:abort");
          ...
          if (i.queuedRequests == null) i.queuedRequests = [];
      ...
      var O = Xt(n, g, C);
      if (r.headers) O = Q(O, r.headers);
      var L = Mt(n, e);
      var q = L.errors;
      var A = L.values;
      if (r.values) A = Q(A, r.values);
      var T = Gt(n);
      var H = Q(A, T);
      var N = jt(H, n);
      ...
      var l = {
        ...
        verb: e,
        errors: q,
        withCredentials: r.credentials || k.credentials ||
          U.config.withCredentials,
      ...
      if (e === "get") {
        ...
        a.open("GET", F, true);
      } else a.open(e.toUpperCase(), t, true);
    ...
    function rr(s, l) {
      ...
      if (Qt(u, /HX-Trigger:/i)) Se(u, "HX-Trigger", s);
      if (Qt(u, /HX-Push:/i)) var c = u.getResponseHeader("HX-Push");
      ...
      if (t.shouldSwap) {
        ...
        var o = function () {
          try {
            ...
            W(n.elts, function (e) {
              if (e.classList) e.classList.add(U.config.settlingClass);
              $(e, "htmx:afterSwap", l);
            });
            if (l.pathInfo.anchor) location.hash = l.pathInfo.anchor;
            ...
            var a = function () {
              ...
              W(n.elts, function (e) {
                if (e.classList) e.classList.remove(U.config.settlingClass);
                $(e, "htmx:afterSettle", l);
              });
              if (h) {
                var e = c || qt(s) || Yt(u) || l.pathInfo.finalPath ||
                  l.pathInfo.path;
                Et(e);
            ...
            if (v.settleDelay > 0) setTimeout(a, v.settleDelay);
            else a();
          } catch (e) {
        ...
        if (v.swapDelay > 0) setTimeout(o, v.swapDelay);
        else o();
      }
      if (e) {
        J(
          ...
          "htmx:responseError",
          Q({
            error: "Response Status Error Code " + u.status + " from " +
              l.pathInfo.path,
          }, l),
        );
      }
    ...
    function lr(e) {
      if (z().readyState !== "loading") e();
      else z().addEventListener("DOMContentLoaded", e);
    }
    function ur() {
      if (U.config.includeIndicatorStyles !== false) {
        z().head.insertAdjacentHTML(
          "beforeend",
          "<style>                      ." + U.config.indicatorClass +
            "{opacity:0;transition: opacity 200ms ease-in;}                      ." +
            U.config.requestClass + " ." + U.config.indicatorClass +
            "{opacity:1}                      ." + U.config.requestClass + "." +
            U.config.indicatorClass + "{opacity:1}                    </style>",
        );
      }
    }
    function fr() {
